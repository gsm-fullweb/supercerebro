...
declare class EvolutionAPI {
    ...
    deleteMessage(accountId: number, instanceName: string, messageId: string, remoteJid: string): Promise<void>;
    editMessage(accountId: number, instanceName: string, messageId: string, remoteJid: string, newText: string): Promise<void>;
    findMessageId(accountId: number, instanceName: string, remoteJid: string, content: string, createdAtSeconds: number): Promise<string | null>;
}
