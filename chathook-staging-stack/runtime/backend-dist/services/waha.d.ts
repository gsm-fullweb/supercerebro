 ...
 */
export declare function deleteWahaSession(sessionName: string, accountId?: number): Promise<boolean>;
/**
 * Desconecta (logout) uma sessão Waha
 */
export declare function logoutWahaSession(sessionName: string, accountId?: number): Promise<boolean>;
/**
 * Reinicia uma sessão Waha (para gerar novo QR code)
 */
export declare function restartWahaSession(sessionName: string, accountId?: number): Promise<boolean>;
/**
 ...
 */
export declare function deleteWahaMessage(accountId: number, sessionName: string, chatId: string, messageId: string): Promise<void>;
export declare function editWahaMessage(accountId: number, sessionName: string, chatId: string, messageId: string, newText: string): Promise<void>;
export declare function findWahaMessageId(accountId: number, sessionName: string, chatId: string, content: string, createdAtSeconds: number): Promise<string | null>;
