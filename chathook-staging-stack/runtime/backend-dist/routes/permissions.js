        ...
        const usersWithPermissions = users.map((user) => {
            ...
            return {
                ...
                permissions: userPerm || {
                    ...
                    wavoipAccess: true,
                    appointmentsAccess: true,
                    atendimentosAccess: true,
                    pwaConversationScope: 'all',
                    disparadorAccess: true,
...
router.put('/user/:userId', async (req, res) => {
    try {
        const accountId = req.accountId;
        const userId = parseInt(req.params.userId);
        const { kanbanAccess, conexoesAccess, chatsInternosAccess, projectsAccess, chatbotFlowsAccess, wavoipAccess, appointmentsAccess, atendimentosAccess, disparadorAccess, permissoesAccess, pwaConversationScope, } = req.body;
        const permissions = await database_1.default.userResourcePermission.upsert({
            ...
            update: {
                ...
                appointmentsAccess: appointmentsAccess !== undefined ? appointmentsAccess : undefined,
                atendimentosAccess: atendimentosAccess !== undefined ? atendimentosAccess : undefined,
                disparadorAccess: disparadorAccess !== undefined ? disparadorAccess : undefined,
                permissoesAccess: permissoesAccess !== undefined ? permissoesAccess : undefined,
                pwaConversationScope: pwaConversationScope !== undefined ? pwaConversationScope : undefined,
                updatedAt: new Date()
            },
            create: {
                accountId,
                ...
                appointmentsAccess: appointmentsAccess !== undefined ? appointmentsAccess : true,
                atendimentosAccess: atendimentosAccess !== undefined ? atendimentosAccess : true,
                disparadorAccess: disparadorAccess !== undefined ? disparadorAccess : true,
                permissoesAccess: permissoesAccess !== undefined ? permissoesAccess : false,
                pwaConversationScope: pwaConversationScope !== undefined ? pwaConversationScope : 'all',
            }
        });
...
router.get('/resources', async (req, res) => {
    try {
        ...
        const allResources = [
            ...
            {
                key: 'appointmentsAccess',
                name: 'Atendimentos',
                description: 'Agendamentos, pacientes, profissionais e serviços',
                icon: '🗓️',
                enabledField: 'appointmentsEnabled'
            },
            {
                key: 'disparadorAccess',
                name: 'Disparador',
                description: 'Envio de campanhas e mensagens em massa',
                icon: '📣',
                enabledField: 'disparadorEnabled'
            },
            {
...
router.put('/account', async (req, res) => {
    try {
        const accountId = req.accountId;
        const { kanbanEnabled, chatsInternosEnabled, conexoesEnabled, projectsEnabled, chatbotFlowsEnabled, wavoipEnabled, appointmentsEnabled, allowedProviders } = req.body;
        const accountPermissions = await database_1.default.accountPermissions.upsert({
            ...
            update: {
                ...
                appointmentsEnabled: appointmentsEnabled !== undefined ? appointmentsEnabled : undefined,
            ...
            create: {
                ...
                appointmentsEnabled: appointmentsEnabled !== undefined ? appointmentsEnabled : true,
